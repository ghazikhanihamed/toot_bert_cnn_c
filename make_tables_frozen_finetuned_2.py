...
# Display the plot
# plt.show()
plt.savefig(os.path.join(LATEX_PATH, "mean_frozen_finetuned_results_task.png"), bbox_inches='tight', dpi=300)
plt.close()
...
# Display the plot
# plt.show()
plt.savefig(os.path.join(LATEX_PATH, "mean_frozen_finetuned_results_classifier.png"), bbox_inches='tight', dpi=300)
plt.close()


# Group by Representer and Representation, and calculate the mean MCC
...
plt.savefig(os.path.join(LATEX_PATH, "mean_frozen_finetuned_results_plm.png"), bbox_inches='tight', dpi=300)
plt.close()