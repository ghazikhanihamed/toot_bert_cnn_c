...
df = pd.read_csv(os.path.join(settings.RESULTS_PATH, "full_trad_cnn_results.csv"))
...
classifiers = ["SVM", "RF", "kNN", "LR", "FFNN", "CNN"]
...
df_mean_results.to_csv(os.path.join(settings.RESULTS_PATH, "mean_balanced_imbalanced_results_trad_cnn.csv"), index=False)