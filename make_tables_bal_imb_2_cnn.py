...
mean_accuracy = df.groupby(['task_short', 'Dataset'])['Accuracy_mean'].mean().reset_index()
std_accuracy = df.groupby(['task_short', 'Dataset'])['Accuracy_std'].mean().reset_index()

mean_sensitivity = df.groupby(['task_short', 'Dataset'])['Sensitivity_mean'].mean().reset_index()
std_sensitivity = df.groupby(['task_short', 'Dataset'])['Sensitivity_std'].mean().reset_index()

mean_specificity = df.groupby(['task_short', 'Dataset'])['Specificity_mean'].mean().reset_index()
std_specificity = df.groupby(['task_short', 'Dataset'])['Specificity_std'].mean().reset_index()
...
sensitivity = pd.merge(mean_sensitivity, std_sensitivity, on=['task_short', 'Dataset'])
specificity = pd.merge(mean_specificity, std_specificity, on=['task_short', 'Dataset'])
...
df_metrics = df_metrics[['task_short', 'Dataset', 'MCC', 'Accuracy', 'Sensitivity', 'Specificity']]
...
# Display the plot
# plt.show()
plt.savefig(os.path.join(LATEX_PATH, "mean_balanced_imbalanced_results_task_cnn.png"), bbox_inches='tight', dpi=300)
plt.close()
...
mean_accuracy = df.groupby(['Classifier', 'Dataset'])['Accuracy_mean'].mean().reset_index()
std_accuracy = df.groupby(['Classifier', 'Dataset'])['Accuracy_std'].mean().reset_index()

mean_sensitivity = df.groupby(['Classifier', 'Dataset'])['Sensitivity_mean'].mean().reset_index()
std_sensitivity = df.groupby(['Classifier', 'Dataset'])['Sensitivity_std'].mean().reset_index()

mean_specificity = df.groupby(['Classifier', 'Dataset'])['Specificity_mean'].mean().reset_index()
std_specificity = df.groupby(['Classifier', 'Dataset'])['Specificity_std'].mean().reset_index()

# Merge the mean and std dataframes for each metric
mcc = pd.merge(mean_mcc, std_mcc, on=['Classifier', 'Dataset'])
accuracy = pd.merge(mean_accuracy, std_accuracy, on=['Classifier', 'Dataset'])
sensitivity = pd.merge(mean_sensitivity, std_sensitivity, on=['Classifier', 'Dataset'])
specificity = pd.merge(mean_specificity, std_specificity, on=['Classifier', 'Dataset'])
...
# Select final columns for the table
df_metrics = df_metrics[['Classifier', 'Dataset', 'MCC', 'Accuracy', 'Sensitivity', 'Specificity']]
...
# Display the plot
# plt.show()
plt.savefig(os.path.join(LATEX_PATH, "mean_balanced_imbalanced_results_classifier_cnn.png"), bbox_inches='tight', dpi=300)
plt.close()
...
mean_accuracy = df.groupby(['plm_size', 'Dataset'])['Accuracy_mean'].mean().reset_index()
std_accuracy = df.groupby(['plm_size', 'Dataset'])['Accuracy_std'].mean().reset_index()

mean_sensitivity = df.groupby(['plm_size', 'Dataset'])['Sensitivity_mean'].mean().reset_index()
std_sensitivity = df.groupby(['plm_size', 'Dataset'])['Sensitivity_std'].mean().reset_index()

mean_specificity = df.groupby(['plm_size', 'Dataset'])['Specificity_mean'].mean().reset_index()
std_specificity = df.groupby(['plm_size', 'Dataset'])['Specificity_std'].mean().reset_index()

# Merge the mean and std dataframes for each metric
mcc = pd.merge(mean_mcc, std_mcc, on=['plm_size', 'Dataset'])
accuracy = pd.merge(mean_accuracy, std_accuracy, on=['plm_size', 'Dataset'])
sensitivity = pd.merge(mean_sensitivity, std_sensitivity, on=['plm_size', 'Dataset'])
specificity = pd.merge(mean_specificity, std_specificity, on=['plm_size', 'Dataset'])
...
# Select final columns for the table
df_metrics = df_metrics[['plm_size', 'Dataset', 'MCC', 'Accuracy', 'Sensitivity', 'Specificity']]
...
# Display the plot
# plt.show()
plt.savefig(os.path.join(LATEX_PATH, "mean_balanced_imbalanced_results_plm_cnn.png"), bbox_inches='tight', dpi=300)
plt.close()
...
std_mcc = finetuned_df.groupby(['plm_size', 'Dataset'])['MCC_std'].mean().reset_index()

mean_accuracy = finetuned_df.groupby(['plm_size', 'Dataset'])['Accuracy_mean'].mean().reset_index()
std_accuracy = finetuned_df.groupby(['plm_size', 'Dataset'])['Accuracy_std'].mean().reset_index()

mean_sensitivity = finetuned_df.groupby(['plm_size', 'Dataset'])['Sensitivity_mean'].mean().reset_index()
std_sensitivity = finetuned_df.groupby(['plm_size', 'Dataset'])['Sensitivity_std'].mean().reset_index()

mean_specificity = finetuned_df.groupby(['plm_size', 'Dataset'])['Specificity_mean'].mean().reset_index()
std_specificity = finetuned_df.groupby(['plm_size', 'Dataset'])['Specificity_std'].mean().reset_index()
...
df_metrics = df_metrics[['plm_size', 'Dataset', 'MCC', 'Accuracy', 'Sensitivity', 'Specificity']]
# Rename columns
df_metrics.columns = ['PLM', 'Dataset', 'MCC', 'Accuracy', 'Sensitivity', 'Specificity']

# Sort the dataframe by PLM size
df_metrics = df_metrics.sort_values('PLM')

# Save the dataframe as a latex table
latex_table = df_metrics.to_latex(index=False, escape=False, column_format='lcccccc')
...
# Display the plot
# plt.show()
plt.savefig(os.path.join(LATEX_PATH, "mean_balanced_imbalanced_results_plm_finetuned_cnn.png"), bbox_inches='tight', dpi=300)
plt.close()
...
std_mcc = frozen_df.groupby(['plm_size', 'Dataset'])['MCC_std'].mean().reset_index()

mean_accuracy = frozen_df.groupby(['plm_size', 'Dataset'])['Accuracy_mean'].mean().reset_index()
std_accuracy = frozen_df.groupby(['plm_size', 'Dataset'])['Accuracy_std'].mean().reset_index()

mean_sensitivity = frozen_df.groupby(['plm_size', 'Dataset'])['Sensitivity_mean'].mean().reset_index()
std_sensitivity = frozen_df.groupby(['plm_size', 'Dataset'])['Sensitivity_std'].mean().reset_index()

mean_specificity = frozen_df.groupby(['plm_size', 'Dataset'])['Specificity_mean'].mean().reset_index()
std_specificity = frozen_df.groupby(['plm_size', 'Dataset'])['Specificity_std'].mean().reset_index()
...
# Display the plot
# plt.show()
plt.savefig(os.path.join(LATEX_PATH, "mean_balanced_imbalanced_results_plm_frozen_cnn.png"), bbox_inches='tight', dpi=300)
plt.close()