...
with open(os.path.join(settings.LATEX_PATH, "mean_balanced_imbalanced_results_trad_cnn.tex"), 'w') as f:
    f.write(latex_table)
...
plt.savefig(os.path.join(settings.LATEX_PATH,
            "mean_balanced_imbalanced_results_bar_plot_delta_trad_cnn.png"), dpi=300, bbox_inches='tight')
...
# Save the plot
plt.savefig(os.path.join(settings.LATEX_PATH,
            "mean_balanced_imbalanced_results_trad_cnn.png"), dpi=300, bbox_inches='tight')
...
plt.savefig(os.path.join(settings.LATEX_PATH,
            "mean_balanced_imbalanced_results_heatmap_trad_cnn.png"), dpi=300, bbox_inches='tight')
